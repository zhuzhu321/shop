                ...
                <!--头部开始-->
                        <div class="top_bar clear">
                            ...
                            <ul class="top_links fr">
                                ...
                                <li><a href="${pageContext.request.contextPath}/index.jsp ">我的账户</a></li>
                                <c:choose>
                                <c:when test="${sessionScope.user!=null}">
                                	<li><a href="${pageContext.request.contextPath}/user/showCart.jsp">购物车</a></li>
                                	<li>
                           				 <a href="#">欢迎您：${user.name }</a>
                           				 <a href="user_outLogin.action">退出</a>
                        			</li>
                                </c:when>
                                <c:otherwise>
                                	<li><a href="${pageContext.request.contextPath}/ulogin.jsp">购物车</a></li>
                                	<li><a href="#">注册</a></li>
                                	<li ><a href="${pageContext.request.contextPath}/ulogin.jsp">登录</a></li> 
                                </c:otherwise>
                                </c:choose>
                            </ul>
                            <!--头部小导航结束-->
